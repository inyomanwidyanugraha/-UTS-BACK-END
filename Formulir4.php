...
<body>
    ...
    <form action="proses4.php" method="POST">
        <fieldset>
            <legend>Form input data Alumni</legend>
    ...
    <table class="tabel">
        ...
        <tr>
            ...
            <td><?= $data['email'] ?></td>
            <td>
               <a href="edit4.php?nim=<?= $data['nim'] ?>"><button>Edit</button></a>
               <a href="delete4.php?nim=<?= $data['nim'] ?>"><button>Delete</button></a>
            </td>
        </tr>
        <?php } ?>
    </table>
