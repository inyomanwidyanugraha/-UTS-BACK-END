...
$qry = "SELECT * FROM alumni WHERE nim = '$nim'";
...
<form action="update4.php" method="POST">
        <fieldset>
            <legend>Form edit data alumni</legend>
            <h2>Lengkapi biodata dengan benar</h2>
            <table>
                <tr>
                    <td>NIM (Nomor induk alumni)</td>
                    <td>:</td>
                ...
                <tr>
                    <td>Nama alumni</td>
                    <td>:</td>
                    <td><input type="text" name="nama" value="<?= $data['nama_alumni'] ?>"></td>
                </tr>
                <tr>
                    <td>Jurusan</td>
                    <td>:</td>
